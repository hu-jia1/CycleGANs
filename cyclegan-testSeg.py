...
parser.add_argument("--dataset_name", type=str, default="SegIR", help="name of the dataset")
...
def sample_images(batches_done):
    ...
    G_AB.eval()
    real_RGB = Variable(imgs["Seg"].type(Tensor))
    ...
    image_grid = torch.cat((real_RGB, fake_RGB, IR), 1)
